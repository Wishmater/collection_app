...
abstract class ItemProvider {
  ...
  static final one = StateProvider.family((
    ref,
    (Collection collection, int id) param,
  ) {
  ...
  static bool saveItem(
    ...
    final saved = itemService.saveItem(item, replaceInList: false);
    if (saved) {
  ...
  static bool addTagToItem(
    AnyRef ref,
    Item item,
    Tag tag, {
    bool checkIfAlreadyExists = true,
  }) {
    final added = itemService.addTagToItem(
      item,
      tag,
      checkIfAlreadyExists: checkIfAlreadyExists,
      saveToDb: true,
  ...
  static bool addItemToAlbum(
    AnyRef ref,
    Item item,
    Item album, {
    bool checkIfAlreadyExists = true,
  }) {
    final added = itemService.addItemToAlbum(
      item,
      album,
      checkIfAlreadyExists: checkIfAlreadyExists,
      saveToDb: true,
